...
public class StatsControllerTest {
    ...
    class AddHit {
        ...
        public void shouldAdd() throws Exception {
            mvc.perform(post(Common.ENDPOINT_HIT)
    ...
    class GetStats {
        ...
        public void shouldGet() throws Exception {
            mvc.perform(get(Common.ENDPOINT_STATS + "?start={start}&end={end}&uris={uris}&uris={uris}&unique={unique}",
        ...
        public void shouldGetWithDefaultUnique() throws Exception {
            mvc.perform(get(Common.ENDPOINT_STATS + "?start={start}&end={end}&uris={uris}&uris={uris}",
        ...
        public void shouldGetWithoutUris() throws Exception {
            mvc.perform(get(Common.ENDPOINT_STATS + "?start={start}&end={end}&unique={unique}",
                            start, end, unique)
                            .characterEncoding(StandardCharsets.UTF_8)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON))
        ...
        public void shouldGetWithoutUrisAndUnique() throws Exception {
            mvc.perform(get(Common.ENDPOINT_STATS + "?start={start}&end={end}",
                            start, end, unique)
                            .characterEncoding(StandardCharsets.UTF_8)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON))
