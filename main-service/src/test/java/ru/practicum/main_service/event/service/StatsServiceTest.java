...
public class StatsServiceTest {
    ...
    private final LocalDateTime startDate = LocalDateTime.parse("2020-08-24 13:30:00", MainCommon.DT_FORMATTER);
    private final LocalDateTime endDate = LocalDateTime.parse("2020-08-24 13:30:00", MainCommon.DT_FORMATTER);
    ...
    class GetViews {
        ...
        public void shouldGet() {
            when(statsClient.getStats(ArgumentMatchers.eq(event2.getPublishedOn()), ArgumentMatchers.any(),
                    ArgumentMatchers.eq(List.of("/events/1", "/events/2")), ArgumentMatchers.eq(true)))
                    .thenReturn(new ResponseEntity<>(List.of(viewStats1, viewStats2), HttpStatus.OK));
